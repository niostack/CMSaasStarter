<script lang="ts">
  ...
  const features = [
    {
      name: "Multi-Phone Control",
      description:
        "One computer can easily control 200+ phones in batch, improving operational efficiency and saving labor costs.",
      link: "https://tikmatrix.com/docs/intro",
      linkText: "Learn More",
      newPage: true,
...
<path d="M17.5 9.74145C17.7095 9.53198 18.0491 9.53198 18.2586 9.74145C18.468 9.95092 18.468 10.2905 18.2586 10.5C18.0491 10.7095 17.7095 10.7095 17.5 10.5C17.2905 10.2905 17.2905 9.95092 17.5 9.74145Z" fill="#1C274C"/>`,
    },
    {
      ...
      link: "",
      description:
        "Each phone can manage 8 TikTok accounts simultaneously, significantly improving account operation efficiency and achieving mass operation.",
      svgContent: `<path
    ...
    {
      name: "Register",
      link: "https://tikmatrix.com/docs/tutorial-scripts/register",
      description:
        "One-click batch auto-register TikTok accounts, supporting custom registration information, greatly improving account creation efficiency.",
...
<path d="M7 3.33782C8.47087 2.48697 10.1786 2 12 2C17.5228 2 22 6.47715 22 12C22 17.5228 17.5228 22 12 22C6.47715 22 2 17.5228 2 12C2 10.1786 2.48697 8.47087 3.33782 7" stroke="#1C274C" stroke-width="1.5" stroke-linecap="round"/>`,
    ...
    {
      name: "Modify Profile",
      link: "https://tikmatrix.com/docs/tutorial-scripts/profile",
      description:
        "Batch auto-modify TikTok account information, including avatar, nickname, username, signature, etc., to improve account authenticity.",
...
<path d="M7 6H12" stroke="#1C274C" stroke-width="1.5" stroke-linecap="round"/>`,
    ...
    {
      name: "Login",
      link: "https://tikmatrix.com/docs/tutorial-scripts/login",
      description:
        "Batch auto-login TikTok accounts, automatically identify logged-in accounts, and efficiently manage account status.",
...
<path d="M14 15C14 14.0572 14 13.5858 14.2929 13.2929C14.5858 13 15.0572 13 16 13C16.9428 13 17.4142 13 17.7071 13.2929C18 13.5858 18 14.0572 18 15C18 15.9428 18 16.4142 17.7071 16.7071C17.4142 17 16.9428 17 16 17C15.0572 17 14.5858 17 14.2929 16.7071C14 16.4142 14 15.9428 14 15Z" stroke="#1C274C" stroke-width="1.5"/>`,
    ...
    {
      name: "Account Warmup",
      link: "https://tikmatrix.com/docs/tutorial-scripts/account-warmup",
      description:
        "Batch auto-like, comment, follow, and collect TikTok accounts to improve account activity and authenticity.",
...
<path d="M2.26121 3.09184L2.50997 2.38429H2.50997L2.26121 3.09184ZM2.24876 2.29246C1.85799 2.15507 1.42984 2.36048 1.29246 2.75124C1.15507 3.14201 1.36048 3.57016 1.75124 3.70754L2.24876 2.29246ZM4.58584 4.32298L5.20507 3.89983V3.89983L4.58584 4.32298ZM5.88772 14.5862L5.34345 15.1022H5.34345L5.88772 14.5862ZM20.6578 9.88275L21.3923 10.0342L21.3933 10.0296L20.6578 9.88275ZM20.158 12.3075L20.8926 12.4589L20.158 12.3075ZM20.7345 6.69708L20.1401 7.15439L20.7345 6.69708ZM19.1336 15.0504L18.6598 14.469L19.1336 15.0504ZM5.70808 9.76V7.03836H4.20808V9.76H5.70808ZM2.50997 2.38429L2.24876 2.29246L1.75124 3.70754L2.01245 3.79938L2.50997 2.38429ZM10.9375 16.25H16.2404V14.75H10.9375V16.25ZM5.70808 7.03836C5.70808 6.3312 5.7091 5.7411 5.65719 5.26157C5.60346 4.76519 5.48705 4.31247 5.20507 
stroke="#1C274C" stroke-width="1.5" stroke-linecap="round"/>`,
    ...
    {
      name: "Engagement Boost Tools",
      link: "/features",
      description:
        "Batch auto-boost target post and live stream engagement, quickly gain more exposure and traffic.",
      svgContent: `
...
<path d="M20.5 19.5L21.5 20.5" stroke="#1C274C" stroke-width="1.5" stroke-linecap="round"/>`,
    },
    {
      ...
      link: "/features",
      description:
        "Batch auto-delete posts, batch auto-update account data, efficiently manage TikTok account content.",
...
<circle cx="19" cy="5" r="3" stroke="#1C274C" stroke-width="1.5"/>`,
    },
    {
      ...
      link: "/features",
      description:
        "Batch auto-collect follower lists, quickly obtain potential customer resources, expand marketing network.",
    ...
    {
      name: "Powerful Technical Support",
      description:
        "Professional technical team provides 24/7 support, solving various problems during use, ensuring stable operation.",
      linkText: "Contact Us",
      newPage: true,
      link: "/contact",
    ...
    <div class="max-w-xl">
      ...
      >
        ...
        <span
          ...
          >Free Trial</span
        >
        <span>TikTok Android Phone Farm</span>
      </div>
      <div class="mt-6 md:mt-10 text-sm md:text-lg">
        Supports <a
          href="https://tikmatrix.com/Download"
        ...
        <a
          href="https://tikmatrix.com/Download"
          class="link font-bold"
          target="_blank">Android devices</a
        >
      </div>
      <div
        class="mt-6 md:mt-4 flex flex-row flex-wrap gap-4 place-content-center"
      >
        <a href="https://tikmatrix.com/Download">
          <button class="btn btn-primary px-6">Download Now</button>
        </a>
        <a href="https://tikmatrix.com/docs/intro">
          <button class="btn btn-outline btn-primary px-6">View Tutorial</button
          >
        </a>
      </div>
    </div>
    ...
    <div class="max-w-lg">
      ...
      >
        <div class="hidden md:block">
          <a href="https://tikmatrix.com" target="_blank" class="link">
            <div class="mockup-browser border">
              ...
              <div class="flex justify-center">
                <img
                  alt="Screenshot of tikmatrix.com homepage"
                  class="aspect-2044/1242"
                  src="https://tikmatrix.com/img/startup1.png?v=4"
                />
              </div>
            </div>
          </a>
        ...
        <div class="min-w-[270px] lg:min-w-[420px] flex mt-6 lg:mt-0">
          <div class="my-auto">
            <div class="px-4 text-lg md:text-xl">
              <a href="https://tikmatrix.com" class="" target="_blank"
                >TikMatrix is a professional <span
                  class="font-bold whitespace-nowrap"
                  >TikTok marketing tool</span
                >
                that helps businesses and individuals
                <span class="underline decoration-secondary decoration-[3px]"
                  >efficiently manage TikTok accounts, improving operational
                  efficiency and marketing results.</span
                ></a
              >
            </div>
            <div class="px-4 mt-6 text-lg md:text-xl">
              ...
              > provides more detailed feature introductions and tutorials.
            </div>
            <div class="mt-4 text-large">
              <a href="https://tikmatrix.com/Download" target="_blank">
                <button class="btn btn-primary btn-wide mt-3">Try it Now</button
                >
              </a>
            </div>
          </div>
